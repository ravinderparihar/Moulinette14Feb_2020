...
import com.moulinette.databinding.RowContestTypeBinding;
import com.moulinette.models.vote.Datum;
...
public class VoteContestTypeAdapter extends RecyclerView.Adapter<VoteContestTypeAdapter.MyViewHolder> {
    ...
    RowContestTypeBinding upcomingDrawsBinding;
    MyViewHolder.MyClickHandler myClickHandler;

    public VoteContestTypeAdapter (Activity c, List<Datum> eventListt) {
        ac = c;
        songList = eventListt;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        upcomingDrawsBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.row_contest_type, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public class MyClickHandler {
            ...
            public void quizClick(View view) {
                ...
                Intent intent = new Intent(ac, VoteCast.class);
                intent.putExtra("SelectedContest_id", songList.get(mDataPosition).getQuestionId());
